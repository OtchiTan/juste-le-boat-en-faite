...
func run_inference(obs: Array, state_ins: int) -> Dictionary:
	...
	if result == null:
		printerr("L'inférence C# a renvoyé Nil. Vérifiez les noms des ports du modèle ONNX.")
		return {} # Renvoie une action par défaut (à adapter selon ta taille d'action)
	return result
